import pytest
from pyservice import Context, Organizer
...
def test_can_run_functions(ctx: Context) -> None:
    ctx["n"] = 3
    actions = Organizer([add_two, add_three])
...
def test_can_stop_with_failure(ctx: Context) -> None:
    ctx["n"] = 3
    actions_with_failure = Organizer([add_two, fail_context, add_three])
...
def test_skip_the_rest_of_the_actions(ctx: Context) -> None:
    ctx["n"] = 3
    actions_with_skip = Organizer([add_two, skip_rest, add_three])
...
def test_can_call_nested_organizer_actions(ctx: Context) -> None:
    ...
    nestable_organizer = Organizer([add_two, add_three])
    nested_organizer = Organizer([add_two, add_three, nestable_organizer.run])
...
def test_can_fail_nested_organizers_action(ctx: Context) -> None:
    ...
    nestable_organizer = Organizer([add_two, fail_context, add_three])
    nested_organizer = Organizer([add_two, add_three, nestable_organizer.run])
